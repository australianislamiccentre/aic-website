      ...
      <section className="py-12 bg-white">
        <div className="max-w-4xl mx-auto px-6 space-y-10 text-gray-600 leading-relaxed">
          <div>
            ...
            <p>
              The Australian Islamic Centre (&ldquo;AIC&rdquo;, &ldquo;we&rdquo;, &ldquo;our&rdquo;, or &ldquo;us&rdquo;) is committed to
              protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and
              safeguard your information when you visit our website at australianislamiccentre.org.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              ...
              device and browsing behaviour, including your IP address, browser type, operating system,
              referring URLs, and pages viewed. This data is collected through cookies and similar
              technologies.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li>Send newsletter communications you have subscribed to</li>
          ...
          <div>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>FundraiseUp</strong> &mdash; processes donations on our behalf. When you make a donation,
                your payment information is handled directly by FundraiseUp in accordance with their
                privacy policy. We do not store your credit card or banking details.
              </li>
              <li>
                <strong>Google Analytics</strong> &mdash; helps us understand how visitors interact with our
                website. Google Analytics uses cookies to collect anonymised usage data.
              </li>
              <li>
                <strong>Sanity CMS</strong> &mdash; manages our website content. No personal visitor data is
                shared with Sanity.
              </li>
              <li>
                <strong>Vercel</strong> &mdash; hosts our website. Vercel may collect standard server logs
          ...
          <div>
            ...
            <p>
              Our website uses cookies to enhance your browsing experience and to analyse site traffic.
          ...
          <div>
            ...
            <p>
              ...
              which it was collected, or as required by law. Newsletter subscribers can unsubscribe at
              any time, after which their data will be removed from our mailing list.
            </p>
          </div>
