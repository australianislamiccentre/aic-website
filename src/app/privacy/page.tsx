 ...
 * Privacy Policy Page
 *
 * Server component that fetches privacy page content from Sanity.
 * Falls back to hardcoded PrivacyContent if no Sanity document exists.
 *
 * @route /privacy
...
export async function generateMetadata(): Promise<Metadata> {
  const page = (await getPageContentBySlug("privacy")) as SanityPageContent | null;
  ...
  if (page?.seo) {
    ...
    return {
      ...
      description: page.seo.metaDescription || "Privacy policy for the Australian Islamic Centre website.",
