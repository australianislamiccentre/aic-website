 ...
 * to populate contact information and form submission endpoints. Accepts
 * optional Sanity page settings to override headings, description, operating
 * hours, and sidebar visibility.
 *
...
interface ContactContentProps {
  settings: SanityContactPageSettings | null;
}
...
export default function ContactContent({ settings }: ContactContentProps) {
  ...
  const formColSpan = showSidebar ? "lg:col-span-2" : "lg:col-span-3";
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mb-8">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-1">
            {accentText ? (
              <>
                {heading} <span className="text-teal-600">{accentText}</span>
              </>
            ) : (
              heading
            )}
